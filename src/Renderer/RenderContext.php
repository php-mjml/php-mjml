...
final class RenderContext
{
     ...
     * @param array<string, string|null>|null     $accordionSettings   Settings inherited from accordion components
     */
    public function __construct(
        ...
        public ?array $accordionSettings = null,
    ) {
     ...
     *     accordionSettings: array<string, string|null>|null
     * }
     */
    public function toArray(): array
    {
        return [
            ...
            'accordionSettings' => $this->accordionSettings,
        ];
    }
    ...
    public static function fromArray(array $data, self $base): self
    {
        return new self(
            ...
            accordionSettings: $data['accordionSettings'] ?? null,
        );
    }
}
